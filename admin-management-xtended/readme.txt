...
* FIXED: Broken Access Control fixed (https://www.cve.org/CVERecord?id=CVE-2025-62965)
...
= 2.4.2 =
* FIXED: WordPress 5.2 compatibility
* FIXED: PHP 7.2 issue with `parse_str()` fixed
